...
class ChangeFragment(private var name: String, private  var article: String, private var shk: String,
    private var vlozhennost: String, private var pallet: String): Fragment(), ChangeView {
    ...
    companion object {
        fun newInstance(name: String, article: String, shk: String, vlozhennost: String, pallet: String): ChangeFragment {
            return ChangeFragment(name, article,  shk, vlozhennost, pallet)
        }
    }
